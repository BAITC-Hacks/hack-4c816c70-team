...
export function DecisionsPage() {
  ...
  if (state.scenario.status === "error") return <main className={styles.state} role="alert"><h1>{copy.failed}</h1><p>{state.scenario.message}</p><Button onClick={() => void loadScenario()}>{copy.retry}</Button><Link href="/">{copy.home}</Link></main>;
