...
const result = { spent: 95, remaining: 5, baselineScore: 52.56, score: 56.54, districts: [], appliedEffects: null, appliedSynergies: [], explanation: { summary: "ok", strengths: [], risks: [], recommendations: [] }, source: "api" } as EvaluationVM;
