...
internal static class ExplanationText
{
    private static readonly IReadOnlyDictionary<string, (string Russian, string Kazakh, string English)> Templates =
        new Dictionary<string, (string, string, string)>
        {
            ...
            ["alt_title"] = (
                "Лучший найденный вариант среди замен одной меры",
                "Бір шараны алмастыру нұсқаларының ішінде табылған ең жақсы нұсқа",
                "Best option found among single-measure replacements"),
            ["goal_score"] = ("Score", "Score", "Score"),
            ["goal_equity"] = ("равенство районов", "аудандар теңдігі", "district equity"),
            ["goal_economy"] = ("экономия бюджета", "бюджетті үнемдеу", "budget savings"),
            ["alt_recommend"] = (
                "Для цели «{0}»: {1}",
                "«{0}» мақсаты үшін: {1}",
                "For the goal “{0}”: {1}"),
            ["alt_no_improvement"] = (
                "Ни одна из {0} допустимых замен одной меры не улучшает цель «{1}» (проверено наборов: {2}); исходный план остаётся лучшим найденным.",
                "Бір шараны алмастырудың рұқсат етілген {0} нұсқасының ешқайсысы «{1}» мақсатын жақсартпайды (тексерілген жиындар: {2}); бастапқы жоспар табылғандардың ішіндегі ең жақсысы болып қалады.",
                "None of the {0} valid single-measure replacements improves the goal “{1}” ({2} sets checked); the original plan remains the best found."),
            ["alt_score_up"] = ("Score растёт: {0} → {1} ({2}).", "Score өседі: {0} → {1} ({2}).", "Score increases: {0} → {1} ({2})."),
            ["alt_score_down"] = ("Score снижается: {0} → {1} ({2}).", "Score төмендейді: {0} → {1} ({2}).", "Score decreases: {0} → {1} ({2})."),
            ["alt_min_up"] = (
                "Оценка самого слабого района растёт: {0} → {1} ({2}).",
                "Ұпайы ең төмен ауданның ұпайы өседі: {0} → {1} ({2}).",
                "The lowest district score increases: {0} → {1} ({2})."),
            ["alt_min_down"] = (
                "Оценка самого слабого района снижается: {0} → {1} ({2}).",
                "Ұпайы ең төмен ауданның ұпайы төмендейді: {0} → {1} ({2}).",
                "The lowest district score decreases: {0} → {1} ({2})."),
            ["alt_average_up"] = (
                "Средневзвешенная оценка районов растёт: {0} → {1} ({2}).",
                "Аудандардың орташа өлшенген ұпайы өседі: {0} → {1} ({2}).",
                "The population-weighted average district score increases: {0} → {1} ({2})."),
            ["alt_average_down"] = (
                "Средневзвешенная оценка районов снижается: {0} → {1} ({2}).",
                "Аудандардың орташа өлшенген ұпайы төмендейді: {0} → {1} ({2}).",
                "The population-weighted average district score decreases: {0} → {1} ({2})."),
            ["alt_cost_down"] = (
                "Расходы снижаются: {0} → {1} (экономия {2}), остаток {3} из {4}.",
                "Шығындар азаяды: {0} → {1} ({2} үнемделеді), {4} бірліктен {3} қалады.",
                "Spending decreases: {0} → {1} (saves {2}), {3} of {4} remains."),
            ["alt_cost_up"] = (
                "Расходы растут: {0} → {1} (+{2}), остаток {3} из {4}.",
                "Шығындар өседі: {0} → {1} (+{2}), {4} бірліктен {3} қалады.",
                "Spending increases: {0} → {1} (+{2}), {3} of {4} remains."),
            ["alt_critical_down"] = (
                "Значений ниже {0} становится меньше: {1} → {2}.",
                "{0} шегінен төмен көрсеткіштер азаяды: {1} → {2}.",
                "Fewer indicators below {0}: {1} → {2}."),
            ["alt_critical_up"] = (
                "Значений ниже {0} становится больше: {1} → {2} (каждое стоит −1 балл).",
                "{0} шегінен төмен көрсеткіштер көбейеді: {1} → {2} (әрқайсысы Score-ды 1 ұпайға төмендетеді).",
                "More indicators below {0}: {1} → {2} (each reduces Score by 1 point)."),
            ["alt_district_up"] = (
                "Оценка района {0} растёт: {1} → {2} ({3}).",
                "{0} ауданының ұпайы өседі: {1} → {2} ({3}).",
                "{0} district score increases: {1} → {2} ({3})."),
            ["alt_district_down"] = (
                "Оценка района {0} снижается: {1} → {2} ({3}).",
                "{0} ауданының ұпайы төмендейді: {1} → {2} ({3}).",
                "{0} district score decreases: {1} → {2} ({3})."),
            ["alt_synergy_gained"] = (
                "Появляется синергия {0}: {1} {2} в районе {3}.",
                "{0} синергиясы пайда болады: {3} ауданындағы {1} көрсеткішіне {2}.",
                "Synergy {0} is gained: {1} {2} in {3}."),
            ["alt_synergy_lost"] = (
                "Теряется синергия {0}: {1} {2} в районе {3}.",
                "{0} синергиясы жоғалады: {3} ауданындағы {1} көрсеткішіне {2}.",
                "Synergy {0} is lost: {1} {2} in {3}."),
        };
