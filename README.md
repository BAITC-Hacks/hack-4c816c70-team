...
| Браузерный прогон предыдущего интерфейса (2820666/a30ea47) | Эталон 52,56 → 56,54, 95/5, районы, синергия и объяснение проверены. На 390 px был найден overflow 4 px. Новый frontend с маршрутами /decisions и /results собран; повторная браузерная проверка ожидается |
